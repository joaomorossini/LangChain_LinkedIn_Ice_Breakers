...
def get_summary_chain() -> LLMChain:
    summary_template = """
         given the information about a person from linkedin {information}, I want you to output:
         1. a short summary
...
def get_ice_breaker_chain() -> LLMChain:
    ice_breaker_template = """
         given the information about a person from linkedin {information}, I want you to suggest:
